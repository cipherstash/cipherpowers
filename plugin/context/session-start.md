...
- `cipherpowers:code-agent` - General development (non-Rust)
...
- `cipherpowers:research-agent` - Multi-angle research exploration
- `cipherpowers:review-collation-agent` - Collate dual verification results
- `cipherpowers:execute-review-agent` - Verify plan adherence after execution
- `cipherpowers:gatekeeper` - Quality gate enforcement

**Commands:**
- `/cipherpowers:brainstorm` - Collaborative idea development
- `/cipherpowers:plan` - Create implementation plans
- `/cipherpowers:execute` - Execute plans with agent dispatch
- `/cipherpowers:code-review` - Request code review
- `/cipherpowers:commit` - Atomic commit workflow
- `/cipherpowers:verify` - Dual verification (docs, plan, execute, research)
- `/cipherpowers:summarise` - Learning capture after work completion
