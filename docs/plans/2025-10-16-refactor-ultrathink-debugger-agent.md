# Refactor Ultrathink-Debugger Agent Implementation Plan
...
**Step 1: Replace current content with template structure**
...
**Step 2: Verify specialization is clear**
...
**Step 2: Verify examples show skill usage**
